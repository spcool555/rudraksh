    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>SIXTEEN MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 65,000 /- (Only)</div>
          <p style={styles.description}>
           Type of bead with 16 natural lines on its surface and is believed to have various benefits for the wearer. It is associated with Lord Shiva, the destroyer of evil, and Lord Ram, the ideal king and warrior.</p>
          {/* <p>
              <strong>Benefits:</strong> 	Willpower, focus, artistic abilities</p>
           */}
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <a
                href="https://wa.me/919834432773?text=Hello! I am interested in Sixteen Mukhi Rudraksha."
                target="_blank"
