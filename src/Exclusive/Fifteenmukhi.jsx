    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>FIFTEEN MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 41,000 /- (Only)</div>
          <p style={styles.description}>
           Including enhancing emotional healing, mental clarity, and intuition, promoting spiritual awareness and growth, and providing protection from negative energies.</p>
          {/* <p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <Link
                to="https://wa.me/919834432773?text=Hello! I am interested in Fifteen Mukhi Rudraksha."
                target="_blank"
