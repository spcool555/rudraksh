    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>Two MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 1500 /- (Only)</div>
          <p style={styles.description}>
            Two Mukhi Rudraksha is known as 2 Face Rudraksha and Do Mukhi Rudraksha. It symbolizes God Shiva and Goddess Parvati. Wearing 2 Mukhi Rudraksha helps in building harmonious relationships, emotional balance, and spiritual progress.
          </p>
          <p>
