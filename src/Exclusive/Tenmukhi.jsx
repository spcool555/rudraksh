    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>TEN MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 2500 /- (Only)</div>
          <p style={styles.description}>
            characterized by ten natural lines or faces on its surface. It is a powerful spiritual tool associated with Lord Vishnu, the divine preserver and protector, providing protection from negativity, negative energy </p>
          <p>
              <strong>Benefits:</strong> 	Protection from negative energies</p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <a
                href="https://wa.me/919834432773?text=Hello! I am interested in Ten Mukhi Rudraksha."
                target="_blank"
