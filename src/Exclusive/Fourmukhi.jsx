    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>Four MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 300 /- (Only)</div>
          <p style={styles.description}>
            Four mukhi Lord Brahma, the creator of knowledge, and the planet Mercury, and is believed to enhance intellectual capacity, concentration, communication, and creativity, as well as calm stress and anxiety.</p>
          <p>
              <strong>Benefits:</strong> Enhances creativity, knowledge, communication</p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <Link
                to="https://wa.me/919834432773?text=Hello! I am interested in Four Mukhi Rudraksha."
                target="_blank"
