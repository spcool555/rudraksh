    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>ELEVEN MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 3000 /- (Only)</div>
          <p style={styles.description}>
            The 11 Mukhi Rudraksha looks like a small, brownish seed with eleven distinct lines running from one end to the other, creating eleven faces on its surface.</p>
          <p>
              <strong>Benefits:</strong>Enhanced intuition, spiritual advancement</p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <a
                href="https://wa.me/919834432773?text=Hello! I am interested in Eleven Mukhi Rudraksha."
                target="_blank"
