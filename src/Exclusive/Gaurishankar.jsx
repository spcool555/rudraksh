    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>GAURI SHANKAR RUDRAKSHA</h2>
          ...
          <p>
              <strong>Benefits:</strong>The combined blessings of Lord Shiva and Goddess Parvati are showered upon the wearer of this Gauri Shankar Rudraksha and hence he is able to lead a better and more Happier, Healthier and a Wealthier Life</p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <Link
                to="https://wa.me/919834432773?text=Hello! I am interested in Gauri Shankar Rudraksha"
                target="_blank"
