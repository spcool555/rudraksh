    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>SEVEN MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 500 /- (Only)</div>
          <p style={styles.description}>
            A special bead with seven facets or faces. Each face represents a different deity or energy, making it a powerful symbol in Hinduism.</p>
          <p>
              <strong>Benefits:</strong> Wealth, prosperity, good fortune</p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <a
                href="https://wa.me/919834432773?text=Hello! I am interested in Seven Mukhi Rudraksha."
                target="_blank"
