    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>TRIJUTI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 4500 /- (Only)</div>
          <p style={styles.description}>
            This bead is considered extremely auspicious and spiritually powerful. Scriptures like the Shiva Purana describe Rudrakshas as the tears of Lord Shiva, carrying his energy and compassion. The Trijuti, being three beads fused in one, is believed to multiply this divine potency.
          </p>
          <p>
              <strong>Benefits:</strong>Strengthens willpower and confidence.</p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <Link
                to="https://wa.me/919834432773?text=Hello! I am interested in Trijuti Rudraksha."
                target="_blank"
