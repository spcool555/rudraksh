    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>NINE MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 3000 /- (Only)</div>
          <p style={styles.description}>
            The nine forms of Goddess Durga. Ruling planets are Ketu and Rahu, but its primary spiritual aspect is the benevolent protection and strength from the Nav Durga.</p>
          <p>
              <strong>Benefits:</strong> Harmony in relationships, emotional balance</p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <a
                href="https://wa.me/919834432773?text=Hello! I am interested in Nine Mukhi Rudraksha."
                target="_blank"
