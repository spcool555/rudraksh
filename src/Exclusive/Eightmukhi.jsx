    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>EIGHT MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 2500 /- (Only)</div>
          <p style={styles.description}>
            The 8 Mukhi Rudraksha is highly beneficial for Virgo (Kanya) and Gemini (Mithuna) Zodiac signs, as it is associated with Lord Ganesha. </p>
          <p>
              <strong>Benefits:</strong> Removes obstacles, brings success</p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <a
                href="https://wa.me/919834432773?text=Hello! I am interested in Eight Mukhi Rudraksha."
                target="_blank"
