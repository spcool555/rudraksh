    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>SIX MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 300 /- (Only)</div>
          <p style={styles.description}>
            Wearing the 6 Mukhi Rudraksha enhances focus and concentration during spiritual practices such as meditation, prayer, and mantra chanting.</p>
          <p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <Link
                to="https://wa.me/919834432773?text=Hello! I am interested in Six Mukhi Rudraksha."
                target="_blank"
