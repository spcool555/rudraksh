    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>FOURTEEN MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 35000 /- (Only)</div>
          <p style={styles.description}>
            14 Mukhi Rudraksha is said to bring success, confidence, courage, and mental clarity, while also providing protection from misfortune and evil influences.</p>
          {/* <p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <a
                href="https://wa.me/919834432773?text=Hello! I am interested in Fourteen Mukhi Rudraksha."
                target="_blank"
