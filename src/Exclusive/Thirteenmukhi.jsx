    ...
    <div style={styles.pageContainer}>
      <div style={styles.productContainer}>
        ...
        <div style={styles.detailsSection}>
          <h2 style={styles.title}>THIRTEEN MUKHI RUDRAKSHA</h2>
          <div style={styles.price}>PRICE : 8000 /- (Only)</div>
          <p style={styles.description}>
            Thirteen natural lines or "mukhis" on its surface, associated with Lord Kaamdev (God of Desire), Lord Indra (King of Gods), and Goddess Mahalaxmi (Goddess of Wealth).</p>
          {/* <p>
          ...
          {/* Buttons */}
            <div className="btn-group">
              ...
              <Link
                to="https://wa.me/919834432773?text=Hello! I am interested in Thirteen Mukhi Rudraksha."
                target="_blank"
